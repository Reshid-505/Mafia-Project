...
const PlayersSchema= new mongoose.Schema({
    ...
    "isDead": Boolean,
    "isProtected": Boolean,
    "killedBy": { type: String, default: undefined }
},{versionKey: false})
...
//         const newRoom = new RoomsModel(newData)
//         await newRoom.save()
//         // socket.join(id)
...
//     })
//     socket.on("setRoles",async (roles)=>{
...
//     let {id} = req.params
//     let findedRoom = await RoomsModel.findById(id)
//     if(!findedRoom){
//         res.status(204).send("empty data")
//     }else{
...
//         }
//         const editedRoom = await RoomsModel.findByIdAndUpdate(id,findedRoom)
//         res.status(201).send(editedRoom)
//     }else{
...
//     let {id} = req.params
//     let findedPlayer = PlayersModel.findById(id)
//     if(!findedPlayer){
//         res.status(204).send("empty data")
//     }else{
...
//     let {id} = req.params
//     let findedPlayer = PlayersModel.findByIdAndDelete(id)
//     if(!findedPlayer){
//         res.status(204).send("empty data")
//     }else{
//         res.status(200).send(findedPlayer)
